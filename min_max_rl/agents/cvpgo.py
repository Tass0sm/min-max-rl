"""Competitive Vanilla Policy Gradient Optimization
...
class TrainingState:
    ...
    cgo_state: ma_gradients.CGOState
...
class CVPGO:
    ...
    def train_fn(
        ...
        gradient_update_fn = ma_gradients.cgo_update_fn(
        ...
        def minibatch_step(
            ...
            optimizer_state, cgo_state, params, key = carry
            ...
            return (optimizer_state, cgo_state, params, key), metrics
        ...
        def update_step(
            ...
            (optimizer_state, cgo_state, params, _), metrics = jax.lax.scan(
                functools.partial(minibatch_step, normalizer_params=normalizer_params),
                (optimizer_state, cgo_state, params, key_grad),
                shuffled_data,
        ...
        def training_step(
            ...
            (optimizer_state, cgo_state, agent_params, _), metrics = jax.lax.scan(
                functools.partial(
                    update_step,
                    data=data,
        ...
        training_state = TrainingState(  # pytype: disable=wrong-arg-types  # jax-ndarray
            ...
            cgo_state=ma_gradients.cgo_init_state(init_params),
