...
from min_max_rl.using_pytorch.car_racing.network import Actor as Actor
from min_max_rl.using_pytorch.car_racing.orca_env_function import getNFcollosionreward
import min_max_rl.using_pytorch.car_racing_simulator.VehicleModel as VehicleModel
import min_max_rl.using_pytorch.car_racing_simulator.Track as Track
...
def main():
    ...
    car_racing_path = resources.files(car_racing)

    p1.load_state_dict(torch.load(str(car_racing_path / ("pretrained_models/" + player1 + ".pth"))))
    p2.load_state_dict(torch.load(str(car_racing_path / ("pretrained_models/" + player2 + ".pth"))))
